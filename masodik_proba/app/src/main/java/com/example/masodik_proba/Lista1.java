    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Lista1.this, ""+text, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        add_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!name.equals("") && db.insertData(name)){
                    Toast.makeText(Lista1.this, "Data added", Toast.LENGTH_SHORT).show();
                    add_food.setText("");
                    listItem.clear();
                    viewData();
                } else {
                    Toast.makeText(Lista1.this, "Data not added", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
