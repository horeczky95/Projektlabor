...
public class List1DatabaseHelper extends SQLiteOpenHelper {

    private static final String TAG = "List1DatabaseHelper";

    private static final String TABLE_NAME = "Lista1";
    ...
    public List1DatabaseHelper(Context context) {
