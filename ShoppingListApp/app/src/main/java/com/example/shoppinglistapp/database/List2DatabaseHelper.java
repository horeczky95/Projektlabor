...
public class List2DatabaseHelper extends SQLiteOpenHelper {

    private static final String TAG = "List2DatabaseHelper";

    private static final String TABLE_NAME = "Lista2";
    ...
    public List2DatabaseHelper(Context context) {
