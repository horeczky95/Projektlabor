...
public class List5DatabaseHelper extends SQLiteOpenHelper {

    private static final String TAG = "List5DatabaseHelper";

    private static final String TABLE_NAME = "Lista5";
    ...
    public List5DatabaseHelper(Context context) {
